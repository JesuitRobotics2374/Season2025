...
public class Pathfind extends Command {
  ...
  public Pathfind(CommandSwerveDrivetrain drivetrain, Pose2d target) {
    ...
    } else if (target.getRotation() == null) {
      throw new IllegalArgumentException("Target rotation cannot be null");
    } else if (target.getTranslation() == null) {
      throw new IllegalArgumentException("Target translation cannot be null");
    }
