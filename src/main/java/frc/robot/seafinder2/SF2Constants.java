...
public class SF2Constants {
  ...
  //  public static final double SEAFINDER2_REEF_FRONT_PADDING = -1.0;  //safety
    ...
    public static final double SEAFINDER2_REEF_RIGHT_BRANCH_OFFSET = 0.123;
    ...
    public static final Setpoint SETPOINT_REEF_T4 = new Setpoint(96, 18.37, WRIST_MIN_POSITION); //around 110 //12.25
